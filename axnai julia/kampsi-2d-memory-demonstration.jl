...
xy = [ 0 0 0 0 2 2 3   3 2 1 1 2 3        ;
       0 1 2 3 3 2 1.5 1 1 1 0 0 0]; #orismos komvon san xyz
...
BC[[1:3 31:33 34:36 37:39]] .= 1; #BC[ignored].=1;
fixedofs = findall(x->x==1,BC[:])
freedofs = findall(x->x==0,BC[:])
#boundary conditions
U = zeros(dofs,1);
F = zeros(dofs,1); F[[5 29 26 16 ]] .= -10e3; F[20] = -5e3; F[17] = 10e3
